...
本文档保留非 GNN 方向的论文线索，只作为背景资料。当前比赛主线是 GNN 候选重排序，GNN 相关研究和实施路线见 [GNN 推荐论文调研](gnn-research-survey.md)。
...
- 若继续研究非 GNN 方向，只能作为隔离实验，并且必须以 [性能基准](performance.md) 中的第一版线上分 `1.1452` 为冠军基线。
