...
tag="dataset2_setwise_relative_context_v2_20260726"
...
setsid -f bash -lc "
  ...
  set +e
  uv run --no-sync python scripts/run_dataset2_setwise_relative_context_v2.py \
    train-select \
    ...
    --v1-model result/dataset2_joint_lgbm_setwise_seed60_20260725/artifacts/dataset2-setwise.npz \
