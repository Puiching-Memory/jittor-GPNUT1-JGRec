...
tag="dataset2_champion_topk_residual_setwise_20260726"
...
setsid -f bash -lc "
  ...
  set +e
  uv run --no-sync python scripts/run_dataset2_champion_topk_residual_setwise.py train-select \
    --source-output-dir result/dataset2_multi_expert_confidence_v2_r3_20260726 \
